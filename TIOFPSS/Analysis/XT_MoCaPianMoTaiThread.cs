...
namespace TIOFPSS.Analysis
{
    ...
    public class XT_MoCaPianMoTaiThreadParamter
    {
        ...
        public XT_MoCaPianMoTaiThreadParamter()
        { }

        public XT_MoCaPianMoTaiThreadParamter(string AsyName, string Path,string SysPath,string ProPath)
        {
