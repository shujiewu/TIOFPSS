...
namespace TIOFPSS.Resources
{
    public class RelativeAnimatingContentControl : ContentControl
    {
                            ...
                            if (state != null)
                            {
                                ...
                                if (sb != null)
                                {
                                    ...
                                    foreach (Timeline timeline in sb.Children)
                                    {
                                        ...
                                        if (da != null)
                                        {
                                            ProcessDoubleAnimation(da, sb);
                                        }
                                        else if (dakeys != null)
                                        {
                                            ProcessDoubleAnimationWithKeys(dakeys, sb);
                                        }
                                    }
                                }
                            }
        ...
        private void ProcessDoubleAnimation(DoubleAnimation da, Storyboard sb)
        {
            ...
            if (da.To.HasValue)
            {
                ...
                if (d.HasValue)
                {
                    _specialAnimations.Add(new DoubleAnimationToAdapter(d.Value, da, this, sb));
                }
            }
            ...
            if (da.From.HasValue)
            {
                ...
                if (d.HasValue)
                {
                    _specialAnimations.Add(new DoubleAnimationFromAdapter(d.Value, da, this, sb));
                }
            }
        }
        ...
        private abstract class GeneralAnimationValueAdapter<T> : AnimationValueAdapter
        {
            ...
            /// <summary>
            /// Gets or sets the Storyboard for the Animation 
            /// </summary>
            protected Storyboard Animation { get; set; }

            /// <summary>
            /// Gets or sets the control to which the storyboard belongs
            /// </summary>
            protected RelativeAnimatingContentControl AnimationControl { get; set; }
            ...
            /// <param name="control">Animation Control where the animation belongs too</param>
            /// <param name="animation">Animation where the frame belongs too</param>
            public GeneralAnimationValueAdapter(DoubleAnimationDimension d, T instance, RelativeAnimatingContentControl control, Storyboard animation)
                : base(d)
            {
                Instance = instance;
                Animation = animation;
            ...
            {
                Animation.Stop(AnimationControl);
                SetValue(sizeToUse * _ratio);
                Animation.Begin(AnimationControl);
            }
        }
        ...
        private class DoubleAnimationToAdapter : GeneralAnimationValueAdapter<DoubleAnimation>
        {
            ...
            /// <param name="control">Animation Control where the animation belongs too</param>
            /// <param name="animation">Animation where the frame belongs too</param>
            public DoubleAnimationToAdapter(DoubleAnimationDimension dimension, DoubleAnimation instance, RelativeAnimatingContentControl control, Storyboard animation)
                : base(dimension, instance, control, animation)
            {
            }
        }
        ...
        private class DoubleAnimationFromAdapter : GeneralAnimationValueAdapter<DoubleAnimation>
        {
            ...
            /// <param name="control">Animation Control where the animation belongs too</param>
            /// <param name="animation">Animation where the frame belongs too</param>
            public DoubleAnimationFromAdapter(DoubleAnimationDimension dimension, DoubleAnimation instance, RelativeAnimatingContentControl control, Storyboard animation)
                : base(dimension, instance, control, animation)
            {
            }
        }
        ...
        private class DoubleAnimationFrameAdapter : GeneralAnimationValueAdapter<DoubleKeyFrame>
        {
            ...
            /// <param name="control">Animation Control where the animation belongs too</param>
            /// <param name="animation">Animation where the frame belongs too</param>
            public DoubleAnimationFrameAdapter(DoubleAnimationDimension dimension, DoubleKeyFrame frame, RelativeAnimatingContentControl control, Storyboard animation)
                : base(dimension, frame, control, animation)
            {
            }
        }
        #endregion
